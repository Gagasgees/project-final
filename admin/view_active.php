            ...
            <div class="box-container">
                <?php 
                    $select_products = $conn->prepare("SELECT products.id,
                                                        ...
                                                        sub_categories.name AS sub_name
                                                        FROM products
                                                        JOIN product_image ON products.id = product_image.product_id JOIN categories ON products.category_id = categories.id JOIN sub_categories ON products.sub_category_id = sub_categories.id WHERE status ='active'");
