...
<head>
    ...
    <title>gesge restaurant admin panel - order confirmed page</title>
</head>
<body>
    ...
    <div class="main">
        ...
        <div class="title2">
            <a href="dashboard.php">dashboard  </a> <span>/ order confirmed </span>
        </div>

        <section class="order-container">
            <h1 class="heading">total order confirmed </h1>
            <div class="box-container">
                <?php 
                    $select_orders = $conn->prepare("SELECT * FROM `orders` WHERE status ='confirmed'");
                ...
                ?>
                <div class="box">
                    <div class="status" style="color: blue;"><?= $fetch_orders['status']; ?> </div>
